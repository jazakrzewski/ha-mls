# MLS game data in Home Assistant

This integration fetches data for a MLS team's current/future game, and creates a sensor with attributes for the details of the game. 
